...
class HasEnumPrioritiesTest extends AbstractTestCase
{
    use UtilisesKitsune;
    ...
    protected function setUp(): void
    {
        ...
        if (version_compare(PHP_VERSION, '8.1.0', '<')) {
            $this->markTestSkipped('Enum is only supported for PHP 8.1 and above.');
        }
     ...
     * @return void
     */
    public function priorityUsesEnumDefinition(DefinesPriority $definesPriority): void
    {
